...
void MyTMP117_Init(I2C_HandleTypeDef i2c); //Manual Initialization by giving the parameters

void MyTMP117_Init_DEFAULT(I2C_HandleTypeDef i2c); //Intialize Default parameter for sensor
